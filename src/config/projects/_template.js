// Template for creating new project configurations
...
sudo mv yourprojectd /usr/local/bin/`,
    ...
    initNodeCmd: (nodeName) => `yourprojectd init ${nodeName || "<YOUR_NODE_NAME>"} --chain-id your-chain-id
wget -O $HOME/.yourproject/config/genesis.json "https://raw.githubusercontent.com/yourproject/repo/main/genesis.json"`,
...
sudo systemctl restart yourprojectd`,
    ...
    autoInstallCmd: `wget -O yourproject.sh https://api.yourproject.com/yourproject.sh && chmod +x yourproject.sh && ./yourproject.sh`,
  },
